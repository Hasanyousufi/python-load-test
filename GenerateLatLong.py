...
def get_directions(api_key, origin, destination):
    url = f"https://api.mapbox.com/directions/v5/mapbox/driving/{origin};{destination}?steps=true&access_token={api_key}"
    try:
...
def extract_lat_lon(directions_data, interval=0.00005):
    lat_lon_list = []
...
def main():
    ...
    filename = "New_Karachi_to_islamabad_route.txt"
